...
function buildList(data) {
    ...
    for (var i = 0; i < data.length; i++) {
        let woodsElCont = document.createElement("div");
        woodsElCont.style.textAlign = "center";

        let woodsElId = document.createElement("p");
        woodsElId.innerText = `ID: ${data[i].id}`;
        woodsElCont.appendChild(woodsElId);

        let woodsElName = document.createElement("p");
        woodsElName.innerText = `Name: ${data[i].name}`;
        woodsElCont.appendChild(woodsElName);

        let woodsElType = document.createElement("p");
        woodsElType.innerText = `Type: ${data[i].type}`;
        woodsElCont.appendChild(woodsElType);

        let woodsElColor = document.createElement("p");
        woodsElColor.innerText = `Color: ${data[i].color}`;
        woodsElColor.classList.add("div-1-color");
        woodsElCont.appendChild(woodsElColor);

        let woodsElInside = document.createElement("p");
        woodsElInside.innerText = `Inside: ${data[i].inside}`;
        woodsElCont.appendChild(woodsElInside);

        let woodsElOutside = document.createElement("p");
        woodsElOutside.innerText = `Outside: ${data[i].outside}`;
        woodsElCont.appendChild(woodsElOutside);

        let woodsElDescription = document.createElement("p");
        woodsElDescription.innerText = `Description: ${data[i].description}`;
        woodsElCont.appendChild(woodsElDescription);

        let woodsElUsed_for = document.createElement("p");
        woodsElUsed_for.innerText = `Used For: ${data[i].used_for}`;
        woodsElCont.appendChild(woodsElUsed_for);

        list.appendChild(woodsElCont);
    }
}
